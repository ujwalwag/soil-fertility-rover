...
def generate_launch_description():
    ...
    world = LaunchConfiguration(
        "world",
        default=os.path.join(pkg_sfr_simulation, "worlds", "farm_world_light.world")
    )
    ...
    farm_world = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_sfr_simulation, "launch", "farm_world.launch.py")
        ]),
        launch_arguments={
            "world": world,
    ...
    gz_bridge_clock = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_sfr_simulation, "launch", "gz_bridge_clock.launch.py")
        ]),
    )
    gz_bridge = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_sfr_simulation, "launch", "gz_bridge.launch.py")
        ]),
    )
    camera_bridge = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_sfr_simulation, "launch", "camera_bridge.launch.py")
        ]),
    ...
    spawn_controllers = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_sfr_simulation, "launch", "spawn_controllers.launch.py")
        ]),
        launch_arguments={"use_sim_time": use_sim_time}.items()
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "world",
            default_value=os.path.join(pkg_sfr_simulation, "worlds", "farm_world_light.world"),
