...
class MapWidget(QFrame):
    ...
    def __init__(self, rover_node, parent=None):
        ...
        # Load map from sfr_navigation (maps live with Nav2 config)
        try:
            from ament_index_python.packages import get_package_share_directory
            pkg = get_package_share_directory("sfr_navigation")
            ...
            if os.path.exists(map_path):
                ...
                fallback = os.path.normpath(
                    os.path.join(base, "..", "..", "..", "sfr_navigation", "config", "maps", "farm_map.pgm")
                )
...
def main():
    ...
    def start_sim():
        ...
        try:
            ...
            subprocess.Popen(
                ["ros2", "launch", "sfr_bringup", "sim.launch.py"],
