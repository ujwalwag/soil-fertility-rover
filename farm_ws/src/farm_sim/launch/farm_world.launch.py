...
def generate_launch_description():
    ...
    world_file = LaunchConfiguration(
        "world", default=os.path.join(pkg_farm_sim, "worlds", "farm_world_light.world")
    )
    ...
    models_path = os.path.join(pkg_farm_sim, "models")
    ...
    spawn_robot_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(pkg_farm_sim, "launch", "spawn_robot.launch.py")
        ]),
        launch_arguments={
    ...
    return LaunchDescription([
        DeclareLaunchArgument("world", default_value=os.path.join(pkg_farm_sim, "worlds", "farm_world_light.world")),
